      ...
      <ul className={styles.navItems}>
        ...
        <li className={styles.navItem}>
          ...
          <ul className={styles.dropdownMenu}>
            ...
            <li className={styles.dropdownItem}>
              <Link to="/films/category/fiction">Fiction</Link>
            </li>
            <li className={styles.dropdownItem}>
              <Link to="/films/category/adventure">Adventure</Link>
            </li>
            <li className={styles.dropdownItem}>
              <Link to="/films/category/thriller">Thriller</Link>
            </li>
            <li className={styles.dropdownItem}>
              <Link to="/films/category/animation">Animation</Link>
            </li>
          </ul>
        </li>
        <li className={styles.navItem}>
          ...
          <ul className={styles.dropdownMenu}>
            <li className={styles.dropdownItem}>
              <Link to="/films/movies/most-watched">Most Watched</Link>
            </li>
            <li className={styles.dropdownItem}>
              <Link to="/films/movies/top-rated">Top Rated</Link>
            </li>
            <li className={styles.dropdownItem}>
              <Link to="/films/movies/trending">Trending</Link>
            </li>
          </ul>
        </li>
      </ul>
