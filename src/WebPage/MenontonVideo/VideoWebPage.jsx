...
<div>
    ...
    <div className={styles.webcontainer}>
        <DropdownMenu />
        <h2 className={styles.masalah}></h2>
        <h2 className={styles.masalah}>📢Jika mengalami masalah,gangguan maupun buffering baca <Link to="">Bantuan</Link> untuk mengalami masalah yang dialami. <br />
        Diskusi Film/Series maupun Request atau komplain ke <a href="https://discord.com/">Discord SanFilms</a> 
        <br /> SELALU GUNAKAN BROWSER CHROME / SAFARI AGAR TIDAK TERJADI MASALAH PADA SAAT MENONTON VIDEO.
        </h2>
