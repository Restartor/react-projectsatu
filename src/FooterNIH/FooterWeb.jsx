...
return (
    ...
    <footer className={styles.footerContainer}>
        <div className={styles.bagianKiriFooterLogo}>
            ...
            <p>Penjelasan SanFilms adalah platform streaming yang menyediakan berbagai film dan serial original dari berbagai jaringan dan kategori.</p>
        </div>
        <div className={styles.navigasikategorifooter}>
            <div className={styles.IbuKategory}>
                <h3>Original Series</h3>
                <ul>
                    <li><Link to="/network/Netflix">Netflix</Link></li>
                    <li><Link to="/network/AmazonPrime">Amazon Prime</Link></li>
                    <li><Link to="/network/DisneyPlus">Disney+</Link></li>
                    <li><Link to="/network/HBO">HBO</Link></li>
                </ul>
            </div>
            <div className={styles.IbuKategory}>
                <h3>Category</h3>
                <ul>
                    <li><Link to="/films/category/Action">Action</Link></li>
                    <li><Link to="/films/category/Comedy">Comedy</Link></li>
                    <li><Link to="/films/category/Drama">Drama</Link></li>
                    <li><Link to="/films/category/Horror">Horror</Link></li>
                    <li><Link to="/films/category/Romance">Romance</Link></li>
                    <li><Link to="/films/category/Sci-fi">Sci-fi</Link></li>
                    <li><Link to="/films/category/Thriller">Thriller</Link></li>
                </ul>
            </div>
        </div>
